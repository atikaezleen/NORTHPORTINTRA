...
<head>
  ...
  <title>Finished  - <?php include('../includes/title.php');?></title>
...
include('db.php');
    ...
    $query=pg_query($con,"select * from reservation where r_status='Finished'")or die(pg_last_error($con));
