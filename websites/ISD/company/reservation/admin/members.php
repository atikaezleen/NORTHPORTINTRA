...
include('db.php');
    ...
    $query=pg_query($con,"select * from member order by member_first")or die(pg_last_error($con));
            ...
            <div class="modal-body" style="height:250px">
              ...
              <form class="form-horizontal" method="post" action="member_update.php">
                  ...
                  <div class="form-group">
                      <label class="control-label col-lg-4" for="username">Name</label>
                      <div class="col-lg-8"> 
                  ...
                  <!-- Title -->
                  <div class="form-group">
                      <label class="control-label col-lg-4" for="password">Position</label>
                      <div class="col-lg-8"> 
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" action="member_save.php">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="first" id="username" placeholder="Name" required>
                      </div>
                  </div> 
                  <!-- Title -->
                  <div class="form-group">
                  ...
                  <!-- Title -->
                  <div class="form-group">
                      <label class="control-label col-lg-2" for="password">Position</label>
                      <div class="col-lg-8"> 
                        <textarea class="form-control" name="address" id="password" placeholder="Position"></textarea>
                      </div>
                  </div>     
