...
include('db.php');
    ...
    $query=pg_query($con,"select * from reservation where r_status='pending'")or die(pg_last_error($con));
              ...
              <form class="form-horizontal" method="post" action="reservation_update.php" enctype='multipart/form-data'>
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="last" id="title" value="<?php echo $r_staff;?>" placeholder="Enter Staff Number">
                      </div>
                  </div> 
                  <div class="form-group">
